...
double Calculate(char *PostfixExpression) {
    ...
    while (Read < Length) {
        ...
        if (Type == OPERAND) {
            ...
            switch (Type) {
                case PLUS: TempResult = Operator1 + Operator2;
                    break;
                case MINUS: TempResult = Operator1 - Operator2;
                    break;
                case MULTIPLY: TempResult = Operator1 * Operator2;
                    break;
                case DIVIDE: TempResult = Operator1 / Operator2;
                    break;
            }
